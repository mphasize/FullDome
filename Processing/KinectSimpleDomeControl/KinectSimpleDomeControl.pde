...
void draw()
{
  ...
  noFill();
  stroke(255);
  line(s.lFootCoords[0] * width, s.lFootCoords[1] * height, s.lFootCoords[2] * -300, s.lFootCoords[0] * width, height, s.lFootCoords[2] * -300);
  PVector handRechts = new PVector(s.rHandCoords[0], s.rHandCoords[1], s.rHandCoords[2]);
  PVector elleRechts = new PVector(s.rElbowCoords[0], s.rElbowCoords[1], s.rElbowCoords[2]);
